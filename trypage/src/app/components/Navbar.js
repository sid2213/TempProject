    ...
    return (
        <>
            <>
                ...
                <div id="sidebar" class="fixed top-16 z-10 right-0 h-[calc(100%-4rem)] w-64 bg-blue-600 text-white transform translate-x-full transition-transform duration-300">
